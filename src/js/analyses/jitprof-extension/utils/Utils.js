...
((function (sandbox) {
    ...
    if(inGraalNode){
      ShadowSpace = Java.type("com.oracle.truffle.jalangi.jitprof.ShadowSpace");
      ShadowSpace.JSNULL = null;
      ShadowSpace.JSOBJECT = Object;
    }
    ...
    var util = {
        ...
        isArr: function (obj) {
            //if(inGraalNode) {
            if(false) {
                var jitprofUtils= Java.type("com.oracle.truffle.eventracer.JITProfUtils");
                return jitprofUtils.isArray(obj);
            }
