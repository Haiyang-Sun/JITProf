...
*/
    function ArrayType() {
        ...
        this.getField = Object.create(null);
        this.getField.arrNumeric = function (iid, base, offset, val, isComputed, isOpAssign, isMethodCall) {
            var shadowInfo = sandbox.getShadowObject(base);
            shadowInfo.count++;
        };
        this.getField.arrNonNumeric = function (iid, base, offset, val, isComputed, isOpAssign, isMethodCall) {
            if(typeof offset === 'string' && isNaN(parseInt(offset))){
                var shadowInfo = sandbox.getShadowObject(base);
                if(shadowInfo.source){
                    shadowInfo.propsGet[offset] = true;
        ...
        // should return val
        this.literal = Object.create(null);
        this.literal.arr = function (iid, val, hasGetterSetter) {
        ...
        //function f(iid, f, base, args, val, isConstructor, isMethod) {
        ...
        this.invokeFun.arr = function (iid, f, base, args, val, isConstructor, isMethod) {
            iid = sandbox.getGlobalIID(iid);
