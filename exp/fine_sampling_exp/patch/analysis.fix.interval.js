...
(function (sandbox) {
    ...
    function invokeFun(iid, base, f, args, isConstructor, isMethod) {
        ...
        if (sandbox.analysis && sandbox.analysis.invokeFun && sample) {
    ...
    function T(iid, val, type, hasGetterSetter) {
        ...
        if (sandbox.analysis && sandbox.analysis.literal && sample) {
    ...
    function G(iid, base, offset, isComputed, isOpAssign, isMethodCall) {
        ...
        if (sandbox.analysis && sandbox.analysis.getFieldPre && sample) {
        ...
        if (sandbox.analysis && sandbox.analysis.getField && sample) {
    ...
    function P(iid, base, offset, val, isComputed, isOpAssign) {
        ...
        if (sandbox.analysis && sandbox.analysis.putFieldPre && sample) {
        ...
        if (sandbox.analysis && sandbox.analysis.putField && sample) {
    ...
    function R(iid, name, val, isGlobal, isScriptLocal) {
        ...
        if (sandbox.analysis && sandbox.analysis.read && sample) {
    ...
    function W(iid, name, val, lhs, isGlobal, isScriptLocal, isDeclaration) {
        ...
        if (sandbox.analysis && sandbox.analysis.write && sample) {
    ...
    function Rt(iid, val) {
        ...
        if (sandbox.analysis && sandbox.analysis._return && sample) {
    ...
    function Fr(iid) {
        ...
        if (sandbox.analysis && sandbox.analysis.functionExit & sample) {
    ...
    function B(iid, op, left, right, isComputed, isOpAssign, isSwitchCaseComparison) {
        ...
        if (sandbox.analysis && sandbox.analysis.binaryPre && sample) {
        ...
        if (sandbox.analysis && sandbox.analysis.binary && sample) {
    ...
    function U(iid, op, left) {
        ...
        if (sandbox.analysis && sandbox.analysis.unaryPre && sample) {
        ...
        if (sandbox.analysis && sandbox.analysis.unary && sample) {
